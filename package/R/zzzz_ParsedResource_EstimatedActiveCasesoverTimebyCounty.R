...
#' ParsedResourceEstimatedActiveCasesoverTimebyCounty
ParsedResourceEstimatedActiveCasesoverTimebyCounty <- R6::R6Class(
  classname = "ParsedResourceEstimatedActiveCasesoverTimebyCounty",
  portable = TRUE,
  ...
  public = list(
    ...
    initialize = function(
      raw_data = NULL,
      can_spawn = FALSE,
      init_data = PARSED_RESOURCE_DATA[["EstimatedActiveCasesoverTimebyCounty"]]
    ) {
